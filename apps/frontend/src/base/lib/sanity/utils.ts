...
import { dataset, projectId, studioUrl } from '@/base/lib/sanity/api';
import { createDataAttribute, CreateDataAttributeProps } from 'next-sanity';
import { getImageDimensions } from '@sanity/asset-utils';
import { Link as SanityLink } from './types';
import { Link, Image } from '@/base/types';
...
export const imageResolver = (
  ...
  const hasLqip = (
    asset: NonNullable<typeof image.asset>
  ): asset is { url: string | null; lqip: string | null } => {
    return 'lqip' in asset;
  };
